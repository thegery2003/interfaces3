...
public class TrackerMouse extends JFrame {
    ...
    public TrackerMouse(){
        ...
        //adds combo box to JFrame
        etiqueta = new JLabel(iconos[0]);
        // displays the first icon
        add(etiqueta);
        // adds tag to JFrame
    }
}